...
export const DrawerHeaderComponent = () => (
  <DrawerHeader className="sticky top-0 z-10 bg-gray-50/95 py-4 text-center backdrop-blur-sm transition-all duration-300 md:py-6">
    <DrawerTitle className="text-2xl font-bold xl:text-[2vw]">All Our Services</DrawerTitle>
    <SeparatorWithColor />
    <DrawerDescription className="mx-auto max-w-[70vw] text-sm text-gray-500 xl:text-[0.9vw]">

...
export const ResizableSection = () => {
  ...
  return (
    <motion.div
      ...
      className="my-16 w-full px-4 md:px-8"
      style={panelStyles}
    >
      <div className="mb-12 text-center">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="mb-4 bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-4xl font-bold text-transparent md:text-5xl xl:text-[3vw]"
        >
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="mx-auto max-w-md text-slate-600 md:text-xl xl:max-w-[40vw] xl:text-[1.3vw]"
        >
      ...
      >
            ...
            <>
              ...
              >
                <div className="relative h-full w-full overflow-hidden">
                  ...
                  >
                    <h3 className="mb-2 text-3xl font-bold md:text-4xl xl:text-[2vw]">
                      {panel.title}
                    </h3>
                    <div className="mb-3 h-1 w-16 bg-white/70 xl:w-[4vw]"></div>
                    <p className="text-lg text-white/90 md:text-xl xl:text-[1.3vw]">
                      {panel.description}
                    </p>
                  </motion.div>
                </div>
        ...
        <div className="absolute -bottom-5 left-1/2 -translate-x-1/2 transform">
          <motion.div
            ...
            className="flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm text-slate-600 shadow-lg md:text-base xl:px-[1vw] xl:py-[0.5vh] xl:text-[1vw]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"

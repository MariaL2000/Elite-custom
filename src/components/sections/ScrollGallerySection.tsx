    ...
    >
      ...
      >
        <div className="flex h-full w-full flex-col md:flex-row">
          ...
          {/* Text Container */}
          <div
            className="flex h-1/2 w-full items-center justify-center bg-slate-950 p-6 text-slate-100 md:h-full md:w-2/5 md:p-8 xl:p-[2vw]"
            style={safariStyles}
          >
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="text-lg text-gray-300 md:text-xl xl:text-[1.2vw]">

...
export const ServiceCard = ({ card }: ServiceCardProps) => {
  ...
  return (
    ...
    >
      <div
        className="absolute top-0 right-0 size-16 rounded-bl-full bg-gradient-to-br from-indigo-500/20 to-teal-500/20 transition-transform duration-500 md:size-20 xl:size-[6vw]"
        style={{
          transform: isHovered ? 'translateX(20px) translateY(-20px)' : 'none',
        }}
      ></div>

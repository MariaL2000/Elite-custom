...
export const DrawerServiceCard = ({ card, index, className }: DrawerServiceCardProps) => (
  <motion.div
    ...
    className={`group relative overflow-hidden rounded-xl border border-gray-800 bg-gray-900/50 p-3 text-gray-100 shadow-lg backdrop-blur-sm transition-all duration-300 md:p-4 lg:p-3 xl:p-[1vw] ${className || ''}`}
    style={{
      minHeight: 'clamp(100px, 12vh, 150px)', // Altura más compacta
    }}
  >
    <div className="absolute top-0 right-0 h-12 w-12 translate-x-5 -translate-y-5 transform rounded-bl-full bg-gradient-to-br from-indigo-500/20 to-teal-500/20 transition-transform duration-500 group-hover:translate-x-2 group-hover:-translate-y-2 md:h-14 md:w-14 lg:h-16 lg:w-16 xl:h-[4vw] xl:w-[4vw] xl:translate-x-[1vw] xl:-translate-y-[1vw]"></div>
